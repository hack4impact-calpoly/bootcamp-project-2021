...
const connection_url = "mongodb+srv://new-user:h4i_bootcamp@cluster0.yhfnc.mongodb.net/RecipesDB?retryWrites=true&w=majority";
...
app.post("/api/recipe", async (req, res) => {
  const {recipeRoute, recipeName, recipeSubtitle, recipeDescription, recipeImage, imageAlt, ingredientList, instructionList } = req.body;
