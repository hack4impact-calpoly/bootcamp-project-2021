function recipeJSON() {
  ...
  document.getElementById("recipeJSONFormat").textContent = JSON.stringify(recipe, null, 4);

  const directionsList = [];
  const directions = document.getElementById("directionsList").getElementsByTagName("li");
