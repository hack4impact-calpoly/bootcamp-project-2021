...
const recipeInfo = [
    ...
    ,
    {
        ...
        "imgSrc": spaghettiPic,
        "description": "Spaghetti bolognese is an Italian pasta dish from Bologna. It consists of spaghetti (long strings of pasta) with an Italian ragù (meat sauce) made with minced beef, pancetta and tomatoes, served with Parmesan cheese. Spaghetti bolognese is one of the most popular pasta dishes eaten outside of Italy.",
        "alt" : "Spaghetti Pic"
    }
    ,
    {
        "id" : "pestoPasta",
        "name": "Pesto Pasta",
        "imgSrc": pestoPastaPic,
        "description": "Pesto Pasta or pesto alla genovese is a sauce originating in Genoa, the capital city of Liguria, Italy. It traditionally consists of crushed garlic, European pine nuts, coarse salt, basil leaves, and hard cheese such as Parmigiano-Reggiano (also known as Parmesan cheese) or Pecorino Sardo (cheese made from sheep's milk), all blended with olive oil.",
        "alt" : "Pesto Pasta Pic"
    }
]
